...
namespace FeatureRuntimeCompilation.FeatureRouting
{
    internal abstract class ActionEndpointDataSourceBase : EndpointDataSource, IDisposable
    {
        ...
        private readonly Func<(CancellationTokenSource, IChangeToken)> _getToken;
        ...
        public ActionEndpointDataSourceBase(IActionDescriptorCollectionProvider actions, Func<(CancellationTokenSource, IChangeToken)> getToken)
        {
            _actions = actions;
            _getToken = getToken;
        ...
        private void UpdateEndpoints()
        {
            lock (Lock)
            {
                ...
                var (cancellationTokenSource, changeToken) = _getToken();
