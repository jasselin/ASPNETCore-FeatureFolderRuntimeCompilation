...
{
    internal class FeatureControllerActionEndpointDataSource : ActionEndpointDataSourceBase
    {
        ...
        public FeatureControllerActionEndpointDataSource(
            IActionDescriptorCollectionProvider actions,
            ActionEndpointFactory endpointFactory,
            Func<(CancellationTokenSource, IChangeToken)> getToken)
            : base(actions, getToken)
        {
